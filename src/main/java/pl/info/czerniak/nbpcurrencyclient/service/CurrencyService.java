...
import pl.info.czerniak.nbpcurrencyclient.mapper.SingleRateMapper;
import pl.info.czerniak.nbpcurrencyclient.mapper.SingleShortRateMapper;
...
public class CurrencyService {
    ...
    public SingleRate getRate(RateCode rateCode) {
    ...
    public SingleShortRate getRateByType(RateCode rateCode, RateType rateType) {
        Map<String, String> uriVariables = new HashMap<>();
        uriVariables.put("rateTable", "C");
        uriVariables.put("rateCode", rateCode.toString());
        ...
        return new SingleShortRateMapper().map(new SingleRateMapper().map(response), rateType);
    }
}
